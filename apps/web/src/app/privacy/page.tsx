...
export const metadata: Metadata = {
  ...
  description:
    "Politica de confidențialitate verificat.xyz — cum colectăm, utilizăm și protejăm datele dumneavoastră.",
};
    ...
    >
      ...
      <section id="gdpr" style={{ marginBottom: "var(--space-10, 40px)" }}>
        ...
        <p style={bodyStyle}>
          ...
          <a href="mailto:privacy@verificat.xyz">privacy@verificat.xyz</a>.
        </p>
      </section>
