      ...
      >
        <div
          ...
          style={{
            ...
            border: `1px solid ${verdictColors[verdict.label]}40`,
            borderRadius: 6,
            padding: "4px 10px",
            fontSize: 20,
            fontWeight: 600,
        ...
        <div
          ...
          style={{ fontSize: 14, color: "#4d4d4d", marginBottom: 16 }}
        >
      ...
      {verdict.sources.length > 0 && (
        <div>
          ...
          {verdict.sources.map((source) => (
            ...
            >
              <div
                style={{ fontWeight: 500, color: "#171717", marginBottom: 4 }}
              >
                {source.title}
              </div>
              <a
