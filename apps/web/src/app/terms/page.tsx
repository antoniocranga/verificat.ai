  ...
  return (
    ...
    >
      ...
      <section id="serviciul" style={{ marginBottom: "var(--space-10, 40px)" }}>
        ...
        <p style={bodyStyle}>
          verificat.ai oferă un asistent de verificare a afirmațiilor din media,
          utilizând procesare avansată de limbaj natural și căutare semantică.
          Serviciul este furnizat &ldquo;ca atare&rdquo; și nu garantează
          acuratețea absolută a verdictelor.
        </p>
      </section>
      ...
      >
        ...
        <p style={bodyStyle}>
          ...
          verificat.ai aparțin echipei de dezvoltare. Conținutul generat de
      ...
      <section id="contact" style={{ marginBottom: "var(--space-10, 40px)" }}>
        ...
        <p style={bodyStyle}>
          ...
          <a href="mailto:legal@verificat.ai" style={linkStyle}>
            legal@verificat.ai
          </a>
        </p>
      </section>
